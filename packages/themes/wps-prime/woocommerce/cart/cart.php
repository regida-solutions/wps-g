		...
		if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
			...
			<div class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
				<div class="woo-cart-layout">
						<div class="woo-cart-layout__first">
							<div class="woo-cart-layout__split woo-cart-layout__split--spacing">
									<div class="product-thumbnail">
										<?php
										if ( ! $product_permalink ) {
											echo $thumbnail; // phpcs:ignore XSS ok.
										} else {
											printf( '<a href="%s">%s</a>', esc_url( $product_permalink ), $thumbnail ); // phpcs:ignore XSS ok.
										}
										?>
									</div>
						...
						<div class="woo-cart-layout__second">
							<div class="woo-cart-layout__split woo-cart-layout__split--reset woo-cart-layout__split--reverse">
						...
						<div class="woo-cart-layout__third">
